...
public interface StudentRepository extends JpaRepository<Student, Long> {
    ...
    Optional<Student> findStudentByFirstNameAndLastNameAndAddressAndGenderAndBirthDate(String firstName, String lastName, String address, Gender gender, LocalDate birthDate);
